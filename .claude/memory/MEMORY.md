...
- [AEO description rollout](project_aeo_description_rollout_2026.md) — Phase A done 2026-04-24 (23 Shorts deleted + About rewritten + 167/215 descriptions got constants block); 47 remain (quota); resume `scripts/aeo-bulk-update.py` after PT midnight; Phase B (per-video LLM content) ramps over wait window
